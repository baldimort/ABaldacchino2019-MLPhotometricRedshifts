...
glob.annz["outDirName"] = "PAUS_advanced16"
...
if glob.annz["doGenInputTrees"]:
  ...
  if   inFileOpt == 0:
    glob.annz["splitTypeTrain"]  = "ANNz_data9a.csv"
    glob.annz["splitTypeTest"]   = "ANNz_data9b.csv"
...
if glob.annz["doOptim"] or glob.annz["doEval"]:
  ...
  # --------------------------------------------------------------------------------------------------
    ...
    glob.annz["inDirName"]      = "PAUS/"
    glob.annz["inAsciiFiles"]   = "ANNz_data9c.csv"
