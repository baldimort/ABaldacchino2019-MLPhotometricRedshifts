...
glob.annz["outDirName"] = "SPEC_advanced10"
...
if glob.annz["doOptim"] or glob.annz["doEval"]:
  ...
  # --------------------------------------------------------------------------------------------------
  glob.annz["addOutputVars"] = "ref_id;zb;pz_width;odds;qz;production_id;paudm_id;ra;dec;zspec;conf;i_auto"
  ...
  # --------------------------------------------------------------------------------------------------
    ...
    glob.annz["inDirName"]      = "PAUS/"
    glob.annz["inAsciiFiles"]   = "ANNz_data11.csv"
    ...
    glob.annz["evalDirPostfix"] = "allPausObjs2"
