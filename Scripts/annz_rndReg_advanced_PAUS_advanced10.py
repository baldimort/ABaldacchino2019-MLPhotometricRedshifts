...
glob.annz["outDirName"] = "PAUS_advanced10"
...
if glob.annz["doTrain"]:
  ...
  for nMLMnow in range(glob.annz["nMLMs"]): 
    ...
    # - example use:
    # --------------------------------------------------------------------------------------------------
    input_vars = "i_auto;umag;bmag;vmag;gmag;rmag;jmag;kmag"
    ...
    input_vars_errors = "i_auto_err;umag_err;bmag_err;vmag_err;gmag_err;rmag_err;jmag_err;kmag_err"
