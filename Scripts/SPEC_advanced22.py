...
glob.annz["outDirName"] = "SPEC_advanced22"
...
if glob.annz["doGenInputTrees"]:
  ...
  glob.annz["inAsciiVars"]  = ascii_vars
  ...
  if   inFileOpt == 0:
    glob.annz["splitTypeTrain"]  = "ANNz_data10a.csv"
    glob.annz["splitTypeTest"]   = "ANNz_data10b.csv"
  ...
  # category based on the selection criteria defined by splitType
    ...
    glob.annz["inAsciiFiles"]    = "ANNz_data5a.csv"
  ...
  if useWgtKNN:
    ...
    glob.annz["inAsciiFiles_wgtKNN"]   = "ANNz_data3.csv"
    glob.annz["inAsciiVars_wgtKNN"]    = ascii_vars
    ...
    # glob.annz["weightInp_wgtKNN"]      = "1/pow(MAG_0*MAG_1*MAG_2*MAG_3*MAG_4*MAG_5*MAG_6*MAG_7*MAG_8*MAG_9, 1.5)"
    # glob.annz["weightRef_wgtKNN"]      = "1/MAG_0"

    # glob.annz["weightVarNames_wgtKNN"] = "MAG_0;MAG_1;MAG_2;MAG_3;MAG_4;MAG_5;MAG_6;MAG_7;MAG_8;MAG_9"
    ...
    glob.annz["trainTestTogether_wgtKNN"] = True
...
if glob.annz["doTrain"]:
  ...
  for nMLMnow in range(glob.annz["nMLMs"]): 
    ...
    # - example use:
    # --------------------------------------------------------------------------------------------------
    input_vars = "i_auto;umag;bmag;vmag;gmag;rmag;jmag;kmag;band0_flux;band1_flux;band2_flux;band3_flux;band4_flux;band5_flux;band6_flux;band7_flux;band8_flux;band9_flux;band10_flux;band11_flux;band12_flux;band13_flux;band14_flux;band15_flux;band16_flux;band17_flux;band18_flux;band19_flux;band20_flux;band21_flux;band22_flux;band23_flux;band24_flux;band25_flux;band26_flux;band27_flux;band28_flux;band29_flux;band30_flux;band31_flux;band32_flux;band33_flux;band34_flux;band35_flux;band36_flux;band37_flux;band38_flux;band39_flux"
    glob.annz["inputVariables"] = input_vars
    ...
    #glob.annz["userMLMopts"] = "ANNZ_MLM=BDT:VarTransform=N:NTrees=300:NormMode=NumEvents:BoostType=AdaBoost:"
    ...
    glob.annz["userMLMopts"] = genRndOpts(nMLMnow)
...
if glob.annz["doOptim"] or glob.annz["doEval"]:
  ...
  if speedUpMCMC:
    ...
    glob.annz["max_optimObj_PDF"] = 10000
  ...
  # --------------------------------------------------------------------------------------------------
  glob.annz["addOutputVars"] = "ref_id;zb;pz_width;odds;qz;production_id;paudm_id;ra;dec;zspec;conf"
  ...
  # --------------------------------------------------------------------------------------------------
  glob.annz["max_sigma68_PDF"] = 0.045
  ...
  # --------------------------------------------------------------------------------------------------
    ...
    glob.annz["inDirName"]      = "PAUS/"
    glob.annz["inAsciiFiles"]   = "ANNz_data10c.csv"
    ...
    glob.annz["inAsciiVars"]    = "F:ref_id;F:zb;F:pz_width;F:odds;F:qz;F:production_id;F:paudm_id;F:ra;F:dec;F:zspec;F:conf;F:i_auto;F:umag;F:bmag;F:vmag;F:gmag;F:rmag;F:jmag;F:kmag;F:i_auto_err;F:umag_err;F:bmag_err;F:vmag_err;F:gmag_err;F:rmag_err;F:jmag_err;F:kmag_err;F:band0_flux;F:band1_flux;F:band2_flux;F:band3_flux;F:band4_flux;F:band5_flux;F:band6_flux;F:band7_flux;F:band8_flux;F:band9_flux;F:band10_flux;F:band11_flux;F:band12_flux;F:band13_flux;F:band14_flux;F:band15_flux;F:band16_flux;F:band17_flux;F:band18_flux;F:band19_flux;F:band20_flux;F:band21_flux;F:band22_flux;F:band23_flux;F:band24_flux;F:band25_flux;F:band26_flux;F:band27_flux;F:band28_flux;F:band29_flux;F:band30_flux;F:band31_flux;F:band32_flux;F:band33_flux;F:band34_flux;F:band35_flux;F:band36_flux;F:band37_flux;F:band38_flux;F:band39_flux;F:band0_flux_error;F:band1_flux_error;F:band2_flux_error;F:band3_flux_error;F:band4_flux_error;F:band5_flux_error;F:band6_flux_error;F:band7_flux_error;F:band8_flux_error;F:band9_flux_error;F:band10_flux_error;F:band11_flux_error;F:band12_flux_error;F:band13_flux_error;F:band14_flux_error;F:band15_flux_error;F:band16_flux_error;F:band17_flux_error;F:band18_flux_error;F:band19_flux_error;F:band20_flux_error;F:band21_flux_error;F:band22_flux_error;F:band23_flux_error;F:band24_flux_error;F:band25_flux_error;F:band26_flux_error;F:band27_flux_error;F:band28_flux_error;F:band29_flux_error;F:band30_flux_error;F:band31_flux_error;F:band32_flux_error;F:band33_flux_error;F:band34_flux_error;F:band35_flux_error;F:band36_flux_error;F:band37_flux_error;F:band38_flux_error;F:band39_flux_error"
    ...
    glob.annz["evalDirPostfix"] = "nFile1"
