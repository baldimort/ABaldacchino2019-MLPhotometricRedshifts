...
def generalSettings():  
  ...
  glob.annz["printPlotExtension"] = ".png"
...
def genRndOpts(aSeed=0):
  ...
  doANN = "ANN" in rndOptTypes ; doBDT = "BDT" in rndOptTypes ; doKNN = "KNN" in rndOptTypes
  Assert("Must allow either \"ANN\", \"BDT\" or both in \"rndOptTypes\"",(doANN or doBDT or doKNN))
