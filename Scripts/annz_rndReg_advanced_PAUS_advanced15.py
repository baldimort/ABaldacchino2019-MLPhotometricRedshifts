...
glob.annz["outDirName"] = "PAUS_advanced15"
...
if glob.annz["doGenInputTrees"]:
  ...
  if   inFileOpt == 0:
    glob.annz["splitTypeTrain"]  = "ANNz_data8a.csv"
    glob.annz["splitTypeTest"]   = "ANNz_data8b.csv"
...
if glob.annz["doOptim"] or glob.annz["doEval"]:
  ...
  # --------------------------------------------------------------------------------------------------
    ...
    glob.annz["inDirName"]      = "PAUS/"
    glob.annz["inAsciiFiles"]   = "ANNz_data8c.csv"
